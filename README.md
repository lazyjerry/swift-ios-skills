...
55 agent skills optimized for **iOS 26+** development with Swift 6.2 and modern Apple frameworks. All code examples, patterns, and guidance target the latest APIs -- Liquid Glass, Swift 6.2 approachable concurrency, Foundation Models, StoreKit 2, SwiftData, async/await URLSession, and more. No deprecated patterns.
...
| **ios-engineering-skills** | app-store-review, apple-on-device-ai, authentication, background-processing, coreml, debugging-instruments, ios-accessibility, ios-localization, ios-networking, ios-security, metrickit-diagnostics, vision-framework |
...
| [ios-security](skills/ios-security/) | Keychain, CryptoKit, Face ID/Touch ID, Secure Enclave, ATS, certificate pinning, DeviceCheck |
...
| [pencilkit-drawing](skills/pencilkit-drawing/) | PKCanvasView, PKDrawing, PKToolPicker, Apple Pencil, PaperKit integration |
| [realitykit-ar](skills/realitykit-ar/) | RealityView, entities, anchors, ARKit world tracking, raycasting, scene understanding |
